...
struct ComputeSize
{
   ...
   * @return a 2d vector
   */
  VORTEX_API static glm::ivec2 GetLocalSize2D();

  /**
   * @brief The default local size for 1D compute shaders
   * @return a integer value
   */
  VORTEX_API static int GetLocalSize1D();
   ...
   */
  VORTEX_API static glm::ivec2 GetWorkSize(const glm::ivec2& size,
   ...
   * @return the group size
   */
  VORTEX_API static glm::ivec2 GetWorkSize(int size, int localSize = GetLocalSize1D());
   ...
   */
  VORTEX_API static ComputeSize Default2D();
   ...
   * @return a default compute size
   */
  VORTEX_API static ComputeSize Default1D();
 ...
 */
VORTEX_API ComputeSize MakeStencilComputeSize(const glm::ivec2& size, int radius);
 ...
 * @return calculate ComputeSize
 */
VORTEX_API ComputeSize MakeCheckerboardComputeSize(const glm::ivec2& size);
...
public:
   ...
   */
  VORTEX_API Bound Bind(const std::vector<BindingInput>& inputs);
   ...
   * @return a bound object, ready to be recorded in a command buffer.
   */
  VORTEX_API Bound Bind(ComputeSize computeSize, const std::vector<BindingInput>& inputs);
