    ...
    , mAlpha(alpha)
{
  ...
  mScanWork.Record([&](vk::CommandBuffer commandBuffer) {
    commandBuffer.debugMarkerBeginEXT({"Particle count", {{0.14f, 0.39f, 0.12f, 1.0f}}}, mDevice.Loader());
    ...
    commandBuffer.debugMarkerBeginEXT({"Particle scan", {{0.59f, 0.20f, 0.35f, 1.0f}}}, mDevice.Loader());
...
void ParticleCount::LevelSetBind(LevelSet& levelSet)
{
  ...
  mParticlePhi.Record([&](vk::CommandBuffer commandBuffer) {
    commandBuffer.debugMarkerBeginEXT({"Particle phi", {{0.86f, 0.72f, 0.29f, 1.0f}}}, mDevice.Loader());
...
void ParticleCount::VelocitiesBind(Velocity& velocity, Renderer::GenericBuffer& valid)
{
  ...
  mParticleToGrid.Record([&](vk::CommandBuffer commandBuffer) {
    commandBuffer.debugMarkerBeginEXT({"Particle to grid", {{0.71f, 0.15f, 0.48f, 1.0f}}}, mDevice.Loader());
  ...
  mParticleFromGrid.Record([&](vk::CommandBuffer commandBuffer) {
    commandBuffer.debugMarkerBeginEXT({"Particle from grid", {{0.35f, 0.11f, 0.87f, 1.0f}}}, mDevice.Loader());
