...
function(vortex2d_find_vulkan)
  if(APPLE)
    ...
    if(IOS_PLATFORM)
      ...
      set(VORTEX2D_OS "macos-arm64-x86_64")
    endif()

  	set(VULKAN_LIBRARIES "-L${MOLTENVK_DIR}/MoltenVK.xcframework/${VORTEX2D_OS} -lMoltenVK -framework Metal -framework IOSurface -framework QuartzCore -framework IOKit -framework Foundation -framework Cocoa" PARENT_SCOPE)
