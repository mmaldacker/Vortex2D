...
function(vortex_find_vulkan)
  if(APPLE)
    ...
    if(IOS_PLATFORM)
      set(VORTEX2D_OS "ios-arm64")
    else()
      set(VORTEX2D_OS "macos-arm64_x86_64")
    endif()

  	set(VULKAN_LIBRARIES "-L${MOLTENVK_DIR}/${VORTEX2D_OS}/static -L${MOLTENVK_DIR}/MoltenVK.xcframework/${VORTEX2D_OS} -lMoltenVK -framework Metal -framework IOSurface -framework QuartzCore -framework IOKit -framework Foundation -framework Cocoa" PARENT_SCOPE)
